...
Reports mask keys and identifiers by default. No telemetry, upload, activation, crack or bypass is included. Uninstall removes application files while retaining user settings and reports.
