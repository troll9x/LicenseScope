using System; using System.Collections.Generic; using System.Linq; using WinLic.Core.Models; using WinLic.Scanners.Adobe.Models;
namespace WinLic.Scanners.Adobe.Classification
{
