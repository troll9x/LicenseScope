...
namespace WinLic.Cli.Tests
{
    [TestClass] public sealed class CliTests
    {
        ...
        private sealed class FakeAudit:IUnifiedAuditService{private readonly AuditResult _r;public int Calls;public FakeAudit(AuditResult r){_r=r;}public Task<AuditResult> RunAllAsync(CancellationToken t,IProgress<AuditProgress>? p=null){Calls++;return Task.FromResult(_r);}}
