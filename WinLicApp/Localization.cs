...
namespace WinLicApp
{
    ...
    public static class L
    {
        ...
        private static readonly Dictionary<string, (string EN, string VIE)> S = new()
        {
            ...
            ["P7_Limit4"]        = ("• KMS38: activates until year 2038 via a token trick — if the KMS server still points to a cloud/local host it is now flagged. KMS38 where no server is configured (fully cleaned) remains undetectable.",
                                    "• KMS38: kích hoạt đến năm 2038 bằng thủ thuật token — nếu máy chủ KMS vẫn trỏ đến host cloud/cục bộ thì sẽ bị phát hiện. KMS38 đã dọn sạch hoàn toàn (không còn cấu hình server) vẫn không thể phát hiện."),
