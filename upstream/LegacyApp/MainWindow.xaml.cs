...
namespace LicenseScope.App
{
    public partial class MainWindow : Window
    {
        ...
        private static readonly string SessionLogPath =
            Path.Combine(Path.GetTempPath(), "licensescope_session.log");
        ...
        private async Task ExportUnifiedAsync(string format)
        {
            ...
            var dialog = new SaveFileDialog { Filter = format.ToUpperInvariant() + " files|*." + format, FileName = "LicenseScope-Audit-" + DateTime.Now.ToString("yyyyMMdd-HHmmss") + "." + format };
        ...
        private void BtnRpConfirm_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (doRestart)
            {
                ...
                Process.Start("shutdown.exe", "/r /t 5 /c \"LicenseScopeManager rearm restart\"");
            }
        }
